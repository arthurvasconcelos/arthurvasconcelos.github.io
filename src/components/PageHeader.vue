  ...
  methods: {
    initHeader() {
      ...
      for(const i in this.points) {
        const c = new this.Circle(this, this.points[i], 2 + Math.random() * 2, 'rgba(255, 255, 255, 0.3)');
    ...
    Circle(vm, pos = null, rad = null, color = null) {
      ...
      this.draw = function() {
        ...
        _this.vm.ctx.arc(_this.pos.x, _this.pos.y, _this.radius, 0, 2 * Math.PI, false);
