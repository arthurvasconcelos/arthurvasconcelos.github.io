            ...
            <ul class="aboutMe-socialList">
                <li class="aboutMe-socialList-item" v-for="(social, index) in filterBy(socials, 'show', true)" :key="`social-${index}`">
                    <a
                        ...
                        <font-awesome-icon :icon="social.iconName" />
                    </a>
                </li>
            </ul>
            <h2 class="subHeadline"><span>Skills</span></h2>
            <skill-gauge name="haskell"></skill-gauge>
            <skill-gauge name="php" :value="87"></skill-gauge>
            <skill-gauge name="javascript" :value="100"></skill-gauge>
            <skill-gauge name="python" :value="28"></skill-gauge>
            <skill-gauge name="c#" :value="50"></skill-gauge>
        </page-content>
    </div>
</template>
...
<script>
    ...
    import PageContent from './shared/page-content.vue';
    import SkillGauge from './shared/skill-gauge.vue';
